...
2. **Identity persistence**: whether the configured identity persists across launches (secure storage) is an engineering decision; design supports both. See `../../product/ios/shepherd-review.md` Open Question 2.

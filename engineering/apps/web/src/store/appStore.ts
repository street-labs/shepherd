...
function autoGenerateFilePrompt(state: AppState & DiffState): string | null {
...
function autoGenerateDiffPrompt(state: AppState & DiffState): string | null {
...
export const useAppStore = create<AppStore>((set, get) => ({
  ...
  setPreamble: (text) => {
    ...
    const prompt = newState.viewMode === 'diff'
      ? autoGenerateDiffPrompt(newState)
      : autoGenerateFilePrompt(newState);
    set({
      preamble: text,

---
product-hash: 79cd3657d122c6903ee9652d107c23493af4ce8c70046a4724c05da34c4fc0c
...
- Web-only criteria (`AC-crp-load-paste`/`upload`/`drag-drop` as browser flows, `NFR-crp-browser-support`, `NFR-crp-responsive-layout`).
- `AC-crp-done-*` and `AC-crp-load-upload`/`drag-drop`: no local server / no file loading on iOS.
